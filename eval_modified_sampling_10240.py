...
'''
Decoding : sampling with 10240 samples
...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    ...
    if opts.DRL_model == 'MF':
        full_path = os.path.join(folder,'actions_RL_sampling_10240_{}_{}_MF.csv'.format(opts.No_of_UAVs, opts.No_of_UGVs))
    else:
        full_path = os.path.join(folder,'actions_RL_sampling_10240_{}_{}.csv'.format(opts.No_of_UAVs, opts.No_of_UGVs))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--width', type=int, default = [256*40], nargs='+',
...
#C:/Users/safwan/OneDrive - University of Illinois Chicago/Documents/PhD-ARL/RL/HADRL-f1b78d039f252bcefa154b0c5dd295f528e8dc89/Trial_4/outputs/mugdrl_15/run_20231121T161101/epoch-41.pt