...
from train_modified import train_epoch, validate, get_inner_model
...
def run(opts):
    ...
    model = model_class(
        ...
        n_charging_station=opts.ugv_graph_size,
    ...
    val_dataset = problem.make_dataset(
        ...
        #size= opts.station_size, unique_mission_points=opts.unique_mission_points, num_samples=opts.val_size, filename=opts.val_dataset)
